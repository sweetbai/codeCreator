<?php
namespace commons\framework\ext\phpmailer;
/**
...
class PHPMailer
{
     ...
     * If empty, the page_current date will be added.
     * @type string
     */
    public $MessageDate = '';
    ...
    public function smtpConnect($options = array())
    {
        ...
        foreach ($hosts as $hostentry) {
            ...
            // The host string prefix can temporarily override the page_current setting for SMTPSecure
    ...
    /**
     * Get the array of strings for the page_current language.
     * @return array
     */
    ...
    /**
     * Get an error message in the page_current language.
     * @access protected
     * @param string $key
     * @return string
     */
