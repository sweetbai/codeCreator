...
class Smarty_Internal_Templateparser
{
    ...
    /**
     * page_current parse tree object
     *
     * @var Smarty_Internal_ParseTree
     */
    ...
    /**
     * insert PHP code in page_current buffer
     *
     * @param string $code
     */
    ...
    function yy_r115()
    {
        if ($this->yystack[ $this->yyidx + 0 ]->minor[ 'var' ] == '\'smarty\'') {
            ...
            // used for array reset,next,prev,end,page_current
    ...
    function yy_r155()
    {
        if (!$this->security ||
            ...
            if (strcasecmp($this->yystack[ $this->yyidx + - 3 ]->minor, 'isset') === 0 ||
                ...
                } elseif (in_array($func_name, array('empty', 'reset', 'page_current', 'end', 'prev', 'next'))) {
