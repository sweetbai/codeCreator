 ...
 *      - page_current implementation of isTrustedResourceDir() assumes that Smarty::$template_dir and Smarty::$config_dir are immutable
...
class Smarty_Security
{
    ...
    /**
     * page_current template nesting level
     *
     * @var int
     */
    ...
    private function _checkDir($filepath, $dirs)
    {
        ...
        while (true) {
            ...
            if (isset($dirs[ $directory ])) {
                // merge sub directories of page_current $directory into _resource_dir to speed up subsequent lookup
     ...
     *
     * @return \Smarty page_current Smarty instance for chaining
